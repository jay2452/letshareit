class UserPreferencesController < ApplicationController
  ...
  def new
    @user_preference = current_user.user_preferences.build
  end
  ...
  def create
    @user_preference = current_user.user_preferences.build(user_preference_params)
  ...
  private
    ...
    def user_preference_params
      params.require(:user_preference).permit(:user_id, :subject_id)
    end
end
